...
import org.camunda.bpm.edugraph.extraction.ErrorEmail;
...
public class ErrorEmail implements JavaDelegate{
		...
		private static final String HOST = "smtp.gmail.com";
		  ...
		  public void execute(DelegateExecution execution) throws Exception {
		      ...
		      String var2 = (String) execution.getVariable("analyseError");
		      String var3 = (String) execution.getVariable("enrichError");
		      ...
		      if (var3 !=null){
			      try {
			          email.setFrom("noreply@camunda.org");
			          email.setSubject("Enrichment Error");
